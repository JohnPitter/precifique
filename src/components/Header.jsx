export default function Header() {
  return (
    <header className="px-4 pt-4 pb-4 sm:px-6 sm:pt-5">
      <div className="animate-rise mx-auto flex max-w-[1380px] flex-wrap items-center justify-between gap-4 rounded-[1.5rem] border border-white/70 bg-surface/82 px-4 py-4 shadow-panel backdrop-blur-xl sm:flex-nowrap sm:px-5">
