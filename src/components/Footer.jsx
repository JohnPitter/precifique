export default function Footer() {
  return (
    <footer className="px-4 pb-10 pt-6 sm:px-6">
      <div className="animate-rise mx-auto flex max-w-[1380px] flex-col gap-4 rounded-[2rem] border border-white/70 bg-surface/80 p-5 shadow-panel backdrop-blur-xl sm:flex-row sm:items-center sm:justify-between sm:p-6">
